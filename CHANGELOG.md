...
- **CUMULUS-2185** - RDS Migration Epic
  - **CUMULUS-2199**
    ...
    - Updated `create` in Rules Model to take in optional `createdAt` and `updatedAt` parameters which sets the value of those fields if not specified during function call.
  - **CUMULUS-2189**
