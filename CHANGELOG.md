...
### Fixed
- **CUMULUS-2233**
  - Fixes /s3credentials bug where user ends up in redirect loop because the expirationTime on the access token generated by EarthdataLoginClient is in seconds and Cookie expiration time expects milliseconds. Fixed by converting seconds into milliseconds. Unit tests were added to test that the expiration time matches a Date in milliseconds.
## [v3.0.0] 2020-10-7
