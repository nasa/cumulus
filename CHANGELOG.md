...
- **CUMULUS-2434**
  ...
  - With the updated `update-granules-cmr-metadata-file-links` task, only the granule UMM-G metadata with version 1.6.2 or later will have the s3 link with type 'GET DATA VIA DIRECT ACCESS' for its science file. Since CMR s3 link type 'GET DATA VIA DIRECT ACCESS' is not valid until UMM-G version [1.6.2](https://cdn.earthdata.nasa.gov/umm/granule/v1.6.2/umm-g-json-schema.json)
