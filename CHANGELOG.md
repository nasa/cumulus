...
- **CUMULUS-4553**
  - Update core python tasks to share dev dependencies through a stub package
  - Update core python task schemas to be generated by pydantic using the shared
    `python-schemas` package.
