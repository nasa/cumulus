...
/**
 * Returns a dummy event for a collection of the given id, used for local testing,
 ...
 * @param {function} payload - A function which takes the event and can override its fields
 ...
 * @param {function} handler - The Lambda event handler
