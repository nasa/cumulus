...
/**
 * Returns an appropriate event source for the given event
 * @param {object} event - The incoming AWS Lambda event
 * @param {object} context - The incoming AWS Lambda context
 * @param {array} maybeSources - Event sources to use for lookup. If null,
 *                               use exports.eventSources)
 * @return A constructed EventSource instance for the given event
 */
