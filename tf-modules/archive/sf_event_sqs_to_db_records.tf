...
resource "aws_lambda_function" "sf_event_sqs_to_db_records" {
  ...
  memory_size      = lookup(var.lambda_memory_sizes, "sf_event_sqs_to_db_records_memory_size", 1024)
...
resource "aws_lambda_function" "write_db_dlq_records_to_s3" {
  ...
  runtime          = "nodejs16.x"
  timeout          = local.sf_event_sqs_lambda_timeout
  memory_size      = lookup(var.lambda_memory_sizes, "write_db_dlq_records_to_s3_memory_size", 512)
