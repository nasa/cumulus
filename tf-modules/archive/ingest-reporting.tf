...
resource "aws_cloudwatch_log_group" "publish_executions_logs" {
  ...
  retention_in_days = lookup(var.cloudwatch_log_retention_periods, "archive_publish_executions_log_retention", 30)
  tags              = var.tags
}
...
resource "aws_cloudwatch_log_group" "publish_granules_logs" {
  ...
  retention_in_days = lookup(var.cloudwatch_log_retention_periods, "archive_publish_granule_log_retention", 30)
  tags              = var.tags
}
...
resource "aws_cloudwatch_log_group" "publish_pdrs_logs" {
  ...
  retention_in_days = lookup(var.cloudwatch_log_retention_periods, "publish_pdr_log_retention", 30)
  tags              = var.tags
}
