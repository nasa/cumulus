...
resource "aws_rds_cluster_parameter_group" "rds_cluster_group_v15" {
  name   = "${var.prefix}-cluster-parameter-group-v15"
  family = var.parameter_group_family_v15
...
resource "aws_rds_cluster" "cumulus" {
  depends_on              = [aws_db_subnet_group.default, aws_rds_cluster_parameter_group.rds_cluster_group_v15]
  ...
  db_cluster_parameter_group_name = aws_rds_cluster_parameter_group.rds_cluster_group_v15.id
