...
/**
 * Validate parsedSpec matches expectations
 *
 * @param {Object} spec - parsed spec
 * @returns {Object} validated spec
 * @throws {Error}
 */
function validateParsedSpec(spec) {
  const parsedSpec = Object.assign({}, spec);
  const { checksum, checksumType } = parsedSpec;
  ...
  delete parsedSpec.checksum;
  delete parsedSpec.checksumType;
  return parsedSpec;
}
...
function parseSpec(pdrName, spec) {
  ...
  return validateParsedSpec(parsedSpec);
}
