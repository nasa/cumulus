...
// rules imports some types from '@cumulus/types/api/rules', not sure if these should be moved there later
 ...
 * postgres for reading.  It differs from the PostgresReconciliationReport interface in that it types
