...
| ems.distribution.serverAccessLogsBucket | (required) | The S3 bucket containing S3 Server Access Logs for any distribution buckets
| ems.distribution.reportsBucket | (required) | The S3 bucket where EMS Distribution Reports will be written
