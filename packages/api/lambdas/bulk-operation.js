...
const { bulkArchiveGranules } = require("@cumulus/api-client/granules");
...
async function batchArchiveGranules(payload) {
  bulkArchiveG
}
/**
...
async function handler(event) {
  ...
  if (event.type === 'BULK_GRANULE_ARCHIVE') {
    return await batchArchiveGranules(event.payload);
  }
