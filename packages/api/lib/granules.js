 ...
 * @param {string} [payload.index] - ES (metrics) index to query
 ...
 * query to ES (metrics) using the provided query and index.
 *
 * @param {Object} payload
 ...
 * @param {string} [payload.index] - Optional parameter of ES (metrics) index to query.
...
async function getGranulesForPayload(payload) {
  ...
  // query ElasticSearch (metrics) if needed
