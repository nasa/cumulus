...
async function getGranule(params) {
  deprecate('@cumulus/integration-tests/granules.getGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.getGranule');
  return granulesApi.getGranule(params);
}


async function waitForGranule(params) {
  deprecate('@cumulus/integration-tests/granules.waitForGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.waitForGranule');
...
async function reingestGranule(params) {
  deprecate('@cumulus/integration-tests/granules.reingestGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.reingestGranule');
...
async function removeFromCMR(params) {
  deprecate('@cumulus/integration-tests/granules.removeFromCMR', '1.20.0', '@cumulus/cumulus-api-client/granules.removeFromCMR');
...
async function applyWorkflow(params) {
  deprecate('@cumulus/integration-tests/granules.applyWorkflow', '1.20.0', '@cumulus/cumulus-api-client/granules.applyWorkflow');
...
async function deleteGranule(params) {
  deprecate('@cumulus/integration-tests/granules.deleteGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.deleteGranule');
...
async function moveGranule(params) {
  deprecate('@cumulus/integration-tests/granules.moveGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.moveGranule');
...
async function removePublishedGranule(params) {
  deprecate('@cumulus/integration-tests/granules.removePublishedGranule', '1.20.0', '@cumulus/cumulus-api-client/granules.removePublishedGranule');
  return granulesApi.removePublishedGranule(params);
}


async function listGranules(params) {
  deprecate('@cumulus/integration-tests/granules.listGranules', '1.20.0', '@cumulus/cumulus-api-client/granules.listGranules');
