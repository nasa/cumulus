...
const createCollection = (params) => {
  deprecate('@cumulus/integration-tests/collections.createCollection', '1.20.0', '@cumulus/cumulus-api-client/collections.createCollection');
...
const deleteCollection = (params) => {
  deprecate('@cumulus/integration-tests/collections.deleteCollection', '1.20.0', '@cumulus/cumulus-api-client/collections.deleteCollection');
...
const getCollection = (params) => {
  deprecate('@cumulus/integration-tests/collections.getCollection', '1.20.0', '@cumulus/cumulus-api-client/collections.getCollection');
