...
async function postRule(params) {
  deprecate('@cumulus/integration-tests/rules.getExecution', '1.21.0', '@cumulus/cumulus-api-client/rules.getExecution');
...
async function updateRule(params) {
  deprecate('@cumulus/integration-tests/rules.updateRule', '1.21.0', '@cumulus/cumulus-api-client/rules.updateRule');
...
async function listRules(params) {
  deprecate('@cumulus/integration-tests/rules.listRules', '1.21.0', '@cumulus/cumulus-api-client/rules.listRules');
...
async function getRule(params) {
  deprecate('@cumulus/integration-tests/rules.getRule', '1.21.0', '@cumulus/cumulus-api-client/rules.getRule');
...
async function deleteRule(params) {
  deprecate('@cumulus/integration-tests/rules.deleteRule', '1.21.0', '@cumulus/cumulus-api-client/rules.deleteRule');
...
async function rerunRule(params) {
  deprecate('@cumulus/integration-tests/rules.rerunRule', '1.21.0', '@cumulus/cumulus-api-client/rules.rerunRule');
