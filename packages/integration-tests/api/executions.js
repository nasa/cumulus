...
const getExecution = async (params) => {
  deprecate('@cumulus/integration-tests/exeuctions.getExecution', '1.20.0', '@cumulus/cumulus-api-client/ems.getExecution');
...
const getExecutions = async (params) => {
  deprecate('@cumulus/integration-tests/exeuctions.getExecutions', '1.20.0', '@cumulus/cumulus-api-client/executions.getExecutions');
...
async function getExecutionStatus(params) {
  deprecate('@cumulus/integration-tests/exeuctions.getExecutionStatus', '1.20.0', '@cumulus/cumulus-api-client/executions.getExecutionStatus');
