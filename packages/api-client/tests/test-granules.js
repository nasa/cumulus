...
test('updateGranuleStatus calls the callback with the expected object', async (t) => {
  ...
  await t.notThrowsAsync(granulesApi.updateGranuleStatus({
    callback,
    prefix: testPrefix,
    granuleId,
    status,
...
test('getGranuleStatus calls the callback with the expected object', async (t) => {
  const { testPrefix, granuleId, status } = t.context;
  const expected = {
    prefix: testPrefix,
    payload: {
  ...
  await t.notThrowsAsync(granulesApi.getGranuleStatus({
    callback,
    prefix: testPrefix,
    granuleId,
  }));
