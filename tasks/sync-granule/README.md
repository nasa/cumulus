...
| sftpFastDownload  | boolean | false        | | If true, sftp download is performed using parallel reads for faster throughput. Lambda ephemeral storage is used to download files before sending to s3. Please note that not all sftp servers have the concurrency support required.                                                                                                                                           |
