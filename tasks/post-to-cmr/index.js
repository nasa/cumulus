...
const { getCmrFiles, publishECHO10XML2CMR } = require('@cumulus/cmrjs');
...
async function postToCMR(event) {
  ...
  const publishRequests = cmrFiles.map((cmrFile) => publishECHO10XML2CMR(cmrFile, creds, bucket, stack));
