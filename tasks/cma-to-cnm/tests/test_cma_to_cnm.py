...
class TestCmaToCnm:
    ...
    def test_mapper(self):
        ...
        assert cnm_message['product']['name'] == '20220111135009-NAVO-L2P_GHRSST-SST1m-VIIRS_NPP-v02.0-fv03.0'
        ...
        assert file['uri'] == 'sftp://ops-metis.jpl.nasa.gov/cumulus-test/gds2/NAVO/20220111135009-NAVO-L2P_GHRSST-SST1m-VIIRS_NPP-v02.0-fv03.0.nc'
        assert file['name'] == '20220111135009-NAVO-L2P_GHRSST-SST1m-VIIRS_NPP-v02.0-fv03.0.nc'
