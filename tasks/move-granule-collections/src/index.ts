...
async function s3MoveNeeded(
  ...
  log.warn('going to check if source exists', { Bucket: targetFile.bucket, Key: targetFile.key })
  ...
  */
  ...
  log.warn('going to check if target exists', { Bucket: sourceFile.bucket, Key: sourceFile.key })
