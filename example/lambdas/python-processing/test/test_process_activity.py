...
class Test(unittest.TestCase):
    ...
    def test_add_ancillary_files(self, upload_mock):
        ...
        expected = 's3://test internal bucket/staging/test-stack/TEST_COLLECTION__TEST_VERSION/test_data_file.hdf.md5'

        self.assertEqual(expected, actual)
        process_object._write_md5sum_file.assert_called_with('test_data_file.hdf.md5', 'fake_md5_hash')
