...
def test_process(mocker, python_process):
    mocker.patch.object(python_process, 'clean_output', return_value=MagicMock(return_value=True))
    mocker.patch.object(python_process, 'add_ancillary_file', return_value='test_data_file.md5')
