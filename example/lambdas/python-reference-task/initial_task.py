"""
Python reference task implementation that takes a
test task input and adds some values to the payloads
for use with PythonReferenceSpec.js
"""
...
def handler(event, _context):
    """ Handler wrapper to run task through the CMA `run_cumulus_task` method """
