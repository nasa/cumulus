module "discover_granules_with_execution_name_prefix_workflow" {
  source = "../../tf-modules/workflow"

  prefix          = var.prefix
  name            = "DiscoverGranulesWithExecutionNamePrefix"
  workflow_config = module.cumulus.workflow_config
  system_bucket   = var.system_bucket
  tags            = local.tags

  state_machine_definition = templatefile(
    "${path.module}/discover_granules_with_execution_name_prefix_workflow.asl.json",
    {
