...
if [[ $bamboo_NGAP_ENV = "SIT" ]]; then
  ...
  export RDS_SECURITY_GROUP=$bamboo_SECRET_SIT_RDS_ACCESS_SECRET_ID
  export RDS_ACCESS_SECRET_ID=$bamboo_SECRET_SIT_RDS_SECURITY_GROUP
  export PDR_NODE_NAME_PROVIDER_BUCKET=$bamboo_PDR_NODE_NAME_PROVIDER_BUCKET
