...
docker exec -i ${container_id}\_build_env_1 /bin/bash -c 'cd /source/cumulus; nyc nyc --exclude cumulus/api ./node_modules/.bin/lerna run test --ignore @cumulus/api --ignore cumulus-integration-tests'
# Run api tests
