...
docker exec -i ${container_id}\_build_env_1 /bin/bash -c "cd /source; mkdir .nyc_output; cp -a $UNIT_TEST_BUILD_DIR/.nyc_output/. /source/.nyc_output/; cp -a $BUILD_DIR/packages/api/.nyc_output/. /source/.nyc_output/; nyc report;"
