...
This can happen if you have multiple subnets configured for the Elasticsearch
cluster, but your config is only creating one ES instance. Updating the
`elasticsearch_config` to increase the number of instances should address this
issue:
