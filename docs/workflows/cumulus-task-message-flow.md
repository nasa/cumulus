...
![Diagram showing show incoming and outgoing Cumulus messages for workflow steps are handled by the Cumulus Message Adapter](assets/cumulus-task-message-flow.png)
